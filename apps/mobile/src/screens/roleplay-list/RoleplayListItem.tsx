...
// 세 형태는 상태 어휘·조작이 문자 그대로 같고 다른 것은 데이터(제목·형태 낱말)와
// 아이콘뿐이라 컴포넌트를 변형으로 가르지 않습니다.

// export하지 않는 사상 표입니다 — 형태 → 아이콘입니다. 여정 맵 항목이 같은 유닛에
// 쓰는 아이콘과 같습니다. `tick`은 이 화면에서 import하지 않습니다(완료 표식 0건).
