...
// 이 전제에 기댑니다.
const items: readonly (BottomNavigatorItem & { readonly id: Tab })[] = [
  {
    id: "journey",
    accessibilityLabel: "여정",
    icon: flag,
    timingFlag: "libitum:navigation:journey",
  },
  {
    id: "roleplay",
    accessibilityLabel: "롤플레이",
    icon: friends,
    timingFlag: "libitum:navigation:roleplay",
  },
  {
    id: "settings",
    accessibilityLabel: "설정",
    icon: settings,
    timingFlag: "libitum:navigation:settings",
  },
];
