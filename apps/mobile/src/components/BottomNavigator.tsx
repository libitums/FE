...
// `<svg content>` 경로를 쓴다 (ADR-0014 D6). `roleplay-list-item.css`와 같은 패턴이다.
...
// 항목은 모듈 내부 상수다 (계약). export하지 않고 props로도 받지 않는다 — 세 탭은
// `Tab` union이 이미 닫아 두었다(LIB-257 §2.1 · §2.8). 배열 순서가 좌→우 배치
// 순서다.
